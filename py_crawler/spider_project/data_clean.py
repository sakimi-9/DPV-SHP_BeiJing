...
if __name__ == "__main__":
    input_filename = "D:\链家二手房爬虫\py_crawler\spider_project\爬取的数据\house_data_8.xlsx"  # 请修改为你的输入文件名
    output_filename = "D:\链家二手房爬虫\py_crawler\spider_project\爬取的数据\house_cleared_8.xlsx"  # 请修改为你想要的输出文件名
