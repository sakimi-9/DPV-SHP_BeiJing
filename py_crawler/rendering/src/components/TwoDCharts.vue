...
const charts = [
    { title: '各区域房源数量统计-柱状图', ref: areaChartContainer, render: renderAreaChart },
    { title: '每平米价格分布-柱状图', ref: priceHistContainer, render: drawUnitPriceDistributionChart },
    { title: '房屋面积大小分布-柱状图', ref: areaHistContainer, render: drawSizeDistributionChart },
    { title: '房屋各户型统计-饼图', ref: unitTypeChartContainer, render: renderUnitTypeChart },
    { title: '关注人数与单价关系-散点图', ref: followPriceScatterContainer, render: renderFollowPriceScatter },
    { title: '关注人数与面积关系-散点图', ref: followAreaScatterContainer, render: renderFollowAreaScatter },
    ...
    { title: '面积-单价关系-散点图', ref: ageFacetScatterContainer, render: renderAgeFacetScatterChart },
