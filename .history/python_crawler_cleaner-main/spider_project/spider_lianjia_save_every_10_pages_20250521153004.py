        ...
        async with self.semaphore:
            ...
            async with aiohttp.ClientSession(
                ...
                try:
                    ...
                    logging.error(
                        f"请求失败: {url}, 状态码: {status}, 响应URL: {response_url}, 错误: {e}"
                    )
