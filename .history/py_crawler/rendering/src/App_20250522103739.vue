...
// Attempt to import dataTool explicitly as a namespace for type recognition
// Note: This might not be the officially recommended way and depends on Echarts package structure.
...
echarts.use([
  ...
  TitleComponent,
  CanvasRenderer,
  // We don't register dataTool via use() in this approach
]);
