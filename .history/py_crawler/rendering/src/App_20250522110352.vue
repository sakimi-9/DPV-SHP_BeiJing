...
let controls: OrbitControls | null = null; // Add controls variable
...
const setupThreeJSScene = (container: HTMLElement, data: ParsedHouse[]) => {
  ...
  // 4. Add Controls
  controls = new OrbitControls(camera, renderer.domElement); // Add OrbitControls
  ...
  console.log('Three.js scene setup complete with OrbitControls.');
};
