...
.nav-button {
    ...
    font-size: 50px;
    /* Increase font size for better icons */
    background-color: transparent;
    /* No background */
    color: #007bff;
    /* Use a more standard blue color, similar to the analysis button */
    border: none;
    cursor: pointer;
    z-index: 10;
    /* Ensure buttons are above the chart */
    padding: 0 10px;
    /* Adjust horizontal margin for spacing from the chart area */
    margin: 0 20px;
    /* Increased margin */
}
...
.left-arrow {
    left: -60px;
    /* Adjust position based on new button size and margin */
}
...
/* Add styles for more visually appealing arrow icons */
.nav-button::before {
    content: '❮';
    /* Unicode for heavy left-pointing angle quotation mark */
}

.right-arrow::before {
    content: '❯';
    /* Unicode for heavy right-pointing angle quotation mark */
}
</style>