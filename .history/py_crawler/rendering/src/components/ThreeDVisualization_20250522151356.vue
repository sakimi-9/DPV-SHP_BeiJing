...
// Adjust camera position and lookAt for a better overview
const CAMERA_POSITION = new THREE.Vector3(0, 600, 600); // Higher and further back
const CAMERA_LOOKAT = new THREE.Vector3(0, 0, 0); // Look at the center of the plane
