    ...
    <div class="charts-2d-container">
        ...
        <div class="chart-carousel">
            ...
            <div class="chart-item-single">
                ...
                <div :ref="currentChart.ref" style="width: 100%; height: 500px;"></div>
            </div>
...
.nav-button {
    ...
    /* Set button width */
    height: 40px;
    /* Set button height to make it square */
    border-radius: 50%;
    /* Make it circular */
...
.nav-button:disabled {
    border-color: #ccc;
    /* Grey out border */
    /* Also need to change SVG color when disabled. This might require adding a class to the SVG or binding styles. */
    /* For now, just changing border color */
}

.nav-button:disabled svg path {
    fill: #ccc;
    /* Grey out SVG paths when disabled */
}
...
/* Remove pseudo-element styles for arrows */
/*
.nav-button::before {
    content: '❮';
}
