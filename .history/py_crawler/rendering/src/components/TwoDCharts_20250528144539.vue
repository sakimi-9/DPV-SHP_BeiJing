...
.chart-row {
    display: none;
    /* Hide the old chart layout rows */
}

.chart-item {
    display: none;
    /* Hide the old chart items */
}
...
.chart-carousel {
    ...
    display: flex;
    /* Keep flex to center the chart item vertically */
    align-items: center;
    justify-content: center;
    /* Center the chart item */
    padding: 0 40px;
    /* Add padding to make space for the absolute buttons */
}
...
.chart-item-single {
    ...
    width: 100%;
    /* Take full width within carousel padding */
