<template>
  <div>
    ...
    <div class="data-analysis-container">
      ...
      <h3>1. 关注人数与单价关系</h3>
      <p>图表特征：横轴为单价（元/平），范围从20,000到80,000元/平；纵轴为关注人数，分档显示（0、20-40、40+）。</p>
      <p>分析发现：</p>
      <p>低价房源（20,000-40,000元/平）：关注人数显著更高（40+），说明刚需购房者对价格敏感，低价区域（如五环外或郊区）更受关注。</p>
      <p>高价房源（60,000-80,000元/平）：关注人数较少（20-40或更低），可能因总价高或目标客群（高端改善型）较小。</p>
      <p>市场分化：单价40,000-60,000元/平可能是过渡区间，关注人数中等，对应中产家庭或学区房需求。</p>

      <h3>2. 关注人数与面积关系</h3>
      <p>图表特征：横轴为面积（平米），范围从20到100㎡；纵轴为关注人数，分档与单价图表一致。</p>
      <p>分析发现：</p>
      <p>小户型（20-60㎡）：更受关注，关注人数集中在40+，反映北京市场以刚需（单身、年轻夫妇）和投资客（小户型易出租）为主。</p>
      <p>大户型（80-100㎡）：关注度下降，关注人数降至20-40档，因总价高且需求群体（改善型家庭）较小。</p>
      <p>异常点：若某大面积房源关注人数突增（如304人），需检查是否为学区房或特殊配套（如公园、地铁）驱动。</p>

      <h3>3. 交叉分析（单价 vs 面积）</h3>
      <p>潜在规律：</p>
      <p>低价小户型：关注度最高，典型为郊区或老破小学区房（如海淀区30㎡学区房）。</p>
      <p>高价小户型：可能位于核心商圈（如国贸），适合投资；关注人数中等。</p>
      <p>低价大户型：较少见，若存在可能是远郊新房（如密云），需验证交通配套。</p>

      <h3>4. 北京市场洞察总结</h3>
      <p>刚需主导：低价（&lt;40,000元/平）、小面积（&lt;60㎡）房源是市场流量主力。</p>
      <p>区域差异：</p>
      <p>高单价关注度低的房源可能集中在西城、东城等传统豪宅区；</p>
      <p>高关注低价房可能来自昌平、大兴等新兴居住区。</p>
      <p>投资信号：小户型高关注度反映租赁市场需求旺盛，可挖掘"职住平衡"热点（如望京、中关村）。</p>

      <h3>进一步分析与建议</h3>
      <h4>气泡图分析</h4>
      <p>关注人数/单价/面积/户型关系：</p>
      <p>小户型（&lt;60㎡）在较低单价（&lt;40,000元/平）时关注度最高，表明这类房源最受刚需购房者欢迎。</p>
      <p>大户型（&gt;80㎡）在较高单价（&gt;60,000元/平）时关注度较低，表明这类房源主要面向改善型需求，但需求量相对较小。</p>

      <h4>平行坐标图分析</h4>
      <p>多维度房源特征关系：</p>
      <p>总楼层、朝向、建筑年代等因素对单价有一定影响。例如，newer buildings (building age &lt; 5 years) tend to have higher unit prices.</p>
      <p>单价较高的房源通常位于总楼层较高的建筑中，且朝向较好（如东南、西南）。</p>

      <h4>热力图分析</h4>
      <p>区域单价密度：</p>
      <p>临河里、梨园等区域的单价密度较高，表明这些区域的房源单价普遍较高。</p>
      <p>双井、CBD等区域的单价密度较低，但可能存在一些高单价的房源，表明这些区域的房价分化较为明显。</p>

      <h4>建议</h4>
      <p>低价房源推广：优先推广低价小户型房源，吸引刚需购房者和投资者的关注。</p>
      <p>高价房源定位：针对高价房源，突出其稀缺性和独特优势（如学区、地段、高品质配套），提升关注度。</p>
      <p>优化供应结构：开发商和中介应优化小户型供应，并强调大户型的功能性（如三孩政策、居家办公需求）。</p>
      <p>区域差异化策略：根据不同区域的特点和需求，制定差异化的营销策略，如在新兴居住区重点推广低价小户型，在传统豪宅区突出高端改善型房源的优势。</p>
    </div>
  </div>
</template>
